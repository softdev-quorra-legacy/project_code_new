...
import 'package:pickup_app/auth_provider.dart';
  ...
  void validateAndSubmit() async {
    if ( validateAndSave()) {
      ...
      try {
        ...
        globals.userId = await auth.createUserWithEmailAndPassword(email, password);
        ...
        addUser(globals.userId, 'N/A', first, last);
        readGames();
